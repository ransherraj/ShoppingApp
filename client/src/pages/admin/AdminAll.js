  ...
  return (
    ...
    <>
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-md-3 col-md-3 bg-dark bg-opacity-50 min-vh-100">
            <AdminMenu />
          </div>
          <div className="col-md-9 col-md-3 bg-secondary bg-opacity-50 vh-100" style={{backgroundImage:`url(${bg})`}}>
